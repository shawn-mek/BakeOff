...
namespace Lsr.Bio.Benchmark.ScreenSimulator.Screen {
    ...
    /// </summary>
    public class ScreenTextParser: InfoTextParser, IScreenTextParser {
        #region members
        /// <summary>
        ...
        public ScreenTextParser() {
            Dictionary<string, ParseLine<ScreenInfo>> lineParsersByHeader = 
                new Dictionary<string, ParseLine<ScreenInfo>>();
            ...
            this.RecordDelimiter = _SCREEN_HEADER_LINE;
        } //end constructor
        #endregion
        ...
        internal void _ParseScreenLine(string screenLine, ref ScreenInfo screenInfo) {
            string[] fields = screenLine.Split(InfoTextParser.DELIMITER.ToCharArray());
        	...
        	screenInfo.NumMasterPlates = Convert.ToInt32(fields[4]);
            screenInfo.NumReplicates = Convert.ToInt32(fields[5]);
            screenInfo.DefaultValue = Convert.ToDouble(fields[6]);
        ...
        internal void _ParseControlLine(string controlLine, ref ScreenInfo screenInfo) {
			string[] fields = controlLine.Split(InfoTextParser.DELIMITER.ToCharArray());
