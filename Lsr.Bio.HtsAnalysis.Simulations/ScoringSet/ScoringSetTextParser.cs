...
namespace Lsr.Bio.HtsAnalysis.Simulations {
	...
	internal class ScoringSetTextParser: InfoTextParser, IScoringSetTextParser {
        ...
        /// </summary>
        private static readonly string _SCORING_WORKFLOW_HEADER_LINE = "#normalization_method	replicate_combination_before_scoring_method	scoring_method	replicate_combination_after_scoring_method	hit_id_method	hit_id_threshold";
        #endregion
		...
		public ScoringSetTextParser() {
            Dictionary<string, _ParseLine<ScoringSetInfo>> lineParsersByHeader =
                new Dictionary<string, _ParseLine<ScoringSetInfo>>();
			...
			this._RECORD_DELIMITER = _SCORING_SET_HEADER_LINE;
        } //end constructor
        #endregion
        ...
        private void _ParseScoringSetLine(string hitSetLine, ref ScoringSetInfo scoringSetInfo) {
            string[] fields = hitSetLine.Split(TextUtilities.TAB.ToCharArray());
        ...
        private void _ParseScoringWorkflowInfoLine(string scoringWorkflowLine, ref ScoringSetInfo scoringSetInfo) {
            string[] fields = scoringWorkflowLine.Split(TextUtilities.TAB.ToCharArray());
        	...
        	string hitIdMethod = fields[4];
        	double hitIdThreshold = Convert.ToDouble(fields[5]);
        	ScoringWorkflowInfo info = new ScoringWorkflowInfo(normalizationMethod, replicateCombBeforeScoringMethod,
        	    scoringMethod, replicateCombAfterScoringMethod, hitIdMethod, hitIdThreshold);
