...
namespace Lsr.Bio.HtsAnalysis.Simulations {
    ...
    /// </summary>
    public class DataSimulationManager {

        #region members
        /// <summary>
        /// Object holding input arguments needed to set up simulation(s).
        /// </summary>
        private DataSimulationInputArguments _InputArguments;
        ...
        public void GenerateNoisyScreens(string[] args) {
            ...
            this._InputArguments = new DataSimulationInputArguments(args);
        ...
        private void _LoadInfos(DataSimulationInputArguments inputs) {
