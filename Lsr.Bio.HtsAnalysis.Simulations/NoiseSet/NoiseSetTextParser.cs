...
namespace Lsr.Bio.HtsAnalysis.Simulations {
    ...
    internal class NoiseSetTextParser: InfoTextParser, INoiseSetTextParser {
        ...
        public NoiseSetTextParser() {
            Dictionary<string, _ParseLine<NoiseSetInfo>> lineParsersByHeader =
                new Dictionary<string, _ParseLine<NoiseSetInfo>>();
            ...
            this._RECORD_DELIMITER = _NOISE_SET_HEADER_LINE;
        } //end constructor
        #endregion
        ...
        private void _ParseNoiseSetLine(string noiseSetLine, ref NoiseSetInfo noiseSetInfo) {
            string floorString;
            string ceilingString;
            string[] fields = noiseSetLine.Split(TextUtilities.TAB.ToCharArray());
        ...
        private void _ParseNoisesLine(string noisesLine, ref NoiseSetInfo noiseSetInfo) {
            string[] fields = noisesLine.Split(TextUtilities.TAB.ToCharArray());
