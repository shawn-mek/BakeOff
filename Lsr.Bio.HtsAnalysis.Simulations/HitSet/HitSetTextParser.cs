...
namespace Lsr.Bio.HtsAnalysis.Simulations {
    ...
    /// </summary>
    internal class HitSetTextParser: InfoTextParser, IHitSetTextParser {
        #region members
        /// <summary>
        ...
        public HitSetTextParser() {
            Dictionary<string, _ParseLine<HitSetInfo>> lineParsersByHeader =
                new Dictionary<string, _ParseLine<HitSetInfo>>();
            ...
            this._RECORD_DELIMITER = _HIT_SET_HEADER_LINE;
        } //end constructor
        #endregion
        ...
        private void _ParseHitSetLine(string hitSetLine, ref HitSetInfo hitSetInfo) {
        ...
        private void _ParseHitsLine(string hitsLine, ref HitSetInfo hitSetInfo) {
            string[] fields = hitsLine.Split(TextUtilities.TAB.ToCharArray());
