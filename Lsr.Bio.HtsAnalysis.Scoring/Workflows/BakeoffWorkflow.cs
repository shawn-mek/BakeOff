...
namespace Lsr.Bio.HtsAnalysis.Scoring {
	public class BakeoffWorkflow: IWorkflow {
		private ScoringWorkflowInfo _WorkflowInfo;
		private ArrayedScreenData _ScreenData;

		public BakeoffWorkflow(ScoringWorkflowInfo workflowInfo) {
		...
		public void Execute(ArrayedScreenData data, IEnumerable<string> signalNames) {
			...
			HitIdTransformer hitIdTranformer = new HitIdTransformer("isHit", hitIdDelegate);
