...
namespace Lsr.Bio.Benchmark.Utilities {
    ...
    /// </summary>
    public abstract class InfoTextParser {
		public static readonly string DELIMITER = "\t";
		public static readonly string VALUE_TYPE_HEADER = "ValueType";

		/// <summary>
		/// Character that is expected at the beginning of all header lines in the input files
		/// </summary>
		public static readonly string COMMENT_MARK = "#";
        ...
        protected delegate void ParseLine<T>(string line, ref T info);
        ...
        /// </summary>
        /// <remarks>I would have preferred to define this as Dictionary_string, _ParseLine_T__ lineParsersByHeader,
        ...
        public List<T> LoadInfo<T>(TextReader reader) where T: new() {
            Dictionary<string, ParseLine<T>> lineParsersByHeader =
                this.LineParsersByHeader as Dictionary<string, ParseLine<T>>;
            List<T> result = new List<T>();
            ParseLine<T> currParseMethod = null;
